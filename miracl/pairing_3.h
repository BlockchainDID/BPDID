...
// parameters: number of pairings n, pointers to G1 and G2 elements
	...
	void start_hash2(void);
	void add_to_hash2(const G1&);
	void add_to_hash2(const G2&);
	void add_to_hash2(const GT&);
	void add_to_hash2(const Big&);
	void add_to_hash2(char *);	
	void start_hash3(void);
	void add_to_hash3(const G1&);
	void add_to_hash3(const G2&);
	void add_to_hash3(const GT&);
	void add_to_hash3(const Big&);
	void add_to_hash3(char *);
	Big finish_hash_to_group(void);
	Big finish_hash_to_aes_key(void);
	Big finish_hash_to_group2(void);
	Big finish_hash_to_aes_key2(void);	
	Big finish_hash_to_group3(void);
	Big finish_hash_to_aes_key3(void);	
	void seed_rng(int s);
	~PFC() ;
};
