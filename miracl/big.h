...
public:
    ...
    Big(char* s) {MR_INIT_BIG mr_instr(fn,s);}
#else
    Big(char* s) {MR_INIT_BIG mr_cinstr(fn,s);}
#endif
#endif
...
#ifndef MR_SIMPLE_IO
#ifdef MR_SIMPLE_BASE
	Big& operator=(char* s){mr_instr(fn,s);return *this;}
#else
    Big& operator=(char* s){mr_cinstr(fn,s);return *this;}
#endif
#endif
